...
// Create a separate method for printing extrahot method to be flexible
// with the output
void CodeCache::print_extrahot(outputStream* st, bool reset_counters) {
  MutexLocker mu(CodeCache_lock, Mutex::_no_safepoint_check_flag);
